  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  {
    // OmniSystem has exactly two states and one command interface on each joint
...
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
  RCLCPP_INFO(rclcpp::get_logger("OmnibotSystemHardware"), "Activating ...please wait...");

//   for (auto i = 0; i < hw_start_sec_; i++)
//   {
//     rclcpp::sleep_for(std::chrono::seconds(1));
//     RCLCPP_INFO(
//       rclcpp::get_logger("OmnibotSystemHardware"), "%.1f seconds left...", hw_start_sec_ - i);
//   }
  // END: This part here is for exemplary purposes - Please do not copy to your production code
  ...
  RCLCPP_INFO(rclcpp::get_logger("OmnibotSystemHardware"), "Successfully activated!");
...
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
//   RCLCPP_INFO(rclcpp::get_logger("OmnibotSystemHardware"), "Deactivating ...please wait...");
...
//   }
  ...
  RCLCPP_INFO(rclcpp::get_logger("OmnibotSystemHardware"), "Successfully deactivated!");
...
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
//   RCLCPP_INFO(rclcpp::get_logger("OmnibotSystemHardware"), "Writing...");
